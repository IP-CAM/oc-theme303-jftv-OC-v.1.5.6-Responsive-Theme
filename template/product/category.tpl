	...
	<div class="box-content">
		...
		<div class="box-product box-subcat">
			<ul class="row"><?php $i=0;?>
				...
				<li class="cat-height span2 <?php echo $a;?>">
  ...
  <div class="product-grid">
	<ul class="row">
	  ...
	  <?php if ($product['special']) { ?>	
		...
		<div class="description"><?php echo mb_substr($product['description'],0,72,'UTF-8').'...'; ?></div>
		...
		<div class="cart-button">
			<div class="cart"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button tooltip-1" title="<?php echo $button_cart; ?>"><i class="icon-shopping-cart"></i><span><?php echo $button_cart; ?></span></a></div>

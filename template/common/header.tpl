...
<header id="header">
	...
	<div class="container">
		...
		<div id="search">
			<div class="inner">
				<div class="button-search"><i class="icon-search"></i><span><?php echo $text_search; ?></span></div>
		...
		<div id="menu">		
					...
					<ul  class="menu">
						...
						<?php if ($category['children']) { ?>
								...
								<?php for ($i = 0; $i < count($category['children']);) { $k = $category['column'];?>
								<?php									
									if( $k == 1)
									{?><ul><?php ;}
									elseif( $k > 1 )
...
<div class="container">
<?php if (!empty($error)) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme303/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
